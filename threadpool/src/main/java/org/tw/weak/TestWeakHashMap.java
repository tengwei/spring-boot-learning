...
public class TestWeakHashMap {
    ...
    static WeakHashMap<String, String> map1 = new WeakHashMap<>();
    static {
        map1.put(new String("a").intern(), new String("abc"));
        map1.put(new String("b").intern(), new String("abc"));
        map1.put(new String("c").intern(), new String("abc"));
        map1.put(new String("d").intern(), new String("abc"));
        map1.put(new String("e").intern(), new String("abc"));
        map1.put(new String("f").intern(), new String("abc"));
        map1.put(new String("g").intern(), new String("abc"));
    }
    //会被回收
